// Логика для страницы лекций по начальной военной подготовке
...
let playlists = [
  {
    ...
    description: 'Основы строевого шага, повороты, построения и команды.',
    icon: '⚔️',
    videos: []
  },
  {
    ...
    description: 'Работа с оружием, правила безопасности, стрельба по мишеням.',
    icon: '🎯',
    videos: []
  }
];
